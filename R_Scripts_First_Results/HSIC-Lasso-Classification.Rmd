...
subtitle: "HSIC-Lasso-Classification"
...
params:
  ...
  iter.thin: 5
  pval.sbc : 0.95
  output_folder : "HSIC-Lasso-Classification_files/"
...
load("/Volumes/GoogleDrive/My Drive/Documents/GitHub/MasterThesis/R_Scripts_First_Results/HSIC-Lasso-Classification.RData")

```
# Description

HSIC-Lasso feature selection on the mRNA microArray data using the Verhaak labels.
...
```{r Loading of HSIC-Lasso feature selection}
HSIC<- read_csv("/Volumes/GoogleDrive/My Drive/Documents/GitHub/MasterThesis/hsic_classification_verhaak_labels.csv", 
