...
subtitle: "HSIC-Lasso-Regression"
...
params:
  ...
  iter.thin: 5
  pval.sbc : 0.95
  output_folder : "HSIC-Lasso-Regression_files/"
...
load("/Volumes/GoogleDrive/My Drive/Documents/GitHub/MasterThesis/R_Scripts_First_Results/HSIC-Lasso-Regression.RData")
...
```{r Loading of HSIC-Lasso feature selection, eval=FALSE}
...
```
```{r}
png(file="HSIC-Lasso-Regression_files/PCA_Train&Test.pdf",width=400,height=350)
p1
dev.off()
```
...
```{r}
png(file="HSIC-Lasso-Regression_files/KMC_Train&Test.pdf",width=400,height=350)
p3
dev.off()
```
...
```
```{r}
png(file="HSIC-Lasso-Regression_files/PCASignature_Train&Test.pdf",width=400,height=350)
p6
dev.off()
```
...
```
```{r}
png(file="HSIC-Lasso-Regression_files/KMC_Training.pdf",width=400,height=350)
p4
dev.off()
```
...
```{r}
png(file="HSIC-Lasso-Regression_files/PCA_Train.pdf",width=400,height=350)
p5
dev.off()
```
...
```{r}
png(file="HSIC-Lasso-Regression_files/likburn_Train.pdf",width=400,height=350)
p7
dev.off()
```
...
```{r}
png(file="HSIC-Lasso-Regression_files/KMC_Test.pdf",width=400,height=350)
p5.new
dev.off()
```
...
```{r}
png(file="HSIC-Lasso-Regression_files/PCA_Test.pdf",width=400,height=350)
p4.new
dev.off()
```
