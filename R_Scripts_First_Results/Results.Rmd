...
The Verhaak samples on the TCGA-GBM dataset were used as training set and the rest of the samples were used as test set. No other normalization method or correction was implemented.
...
### PCA of training and testing sets
