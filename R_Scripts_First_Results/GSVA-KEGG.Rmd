...
subtitle: "GSVA-KEGG preprocessing"
...
load("/Volumes/GoogleDrive/My Drive/Documents/GitHub/MasterThesis/R_Scripts_First_Results/GSVA-KEGG.RData")
```
...
```
```{r PCA PLAGE}
#Y.pre.train.plage.norm<-scale(Y.pre.train.plage,center=TRUE,scale=TRUE)
#Y.pre.test.plage.norm<-scale(Y.pre.test.plage,center=TRUE,scale=TRUE)
