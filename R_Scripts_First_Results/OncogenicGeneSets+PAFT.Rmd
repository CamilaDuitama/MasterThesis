...
p7<-qplot(seq_along(to_plot$likli.burnin), to_plot$likli.burnin)+labs(title="Log-likelihood trace plot",y ="Log-likelihood",x="Iteration")
p7
```
...
names(heatmapdata)<-signature.sbc
