...
datasets<-c("Results.RData","Karnofsky_corrected_results.RData","GSVA-KEGG.RData","GSVA-Oncogenic_Signature.RData","GSVA.RData","OncogenicGeneSets+Pcox.RData","OncogenicGeneSets+PAFT.RData","HSIC-Lasso-Regression.RData")
