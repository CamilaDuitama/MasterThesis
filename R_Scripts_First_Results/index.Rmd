...
```{r}
valueBox(value = 11,caption = "Linear predictor of GLM using time-to-event data on the Oncogenic gene sets",href="OncogenicGeneSets+PAFT.html", color= "#21618C")
```

### Chart 16

```{r}
valueBox(value = 11.1, caption="Analysis of results 11",href="AnalysisOfResults1.html", color= "#FA8072")
```
...
```{r}
valueBox(value = 14,caption = "HSIC-Lasso for feature selection using survival data (Regression)",href="HSIC-Lasso-Regression.html", color= "#1B4F72")
```

### Chart 15

```{r}
valueBox(value = 14.1, caption= "Analysis of results 14",href="AnalysisOfResults1.html", color= "#CD5C5C")
```
