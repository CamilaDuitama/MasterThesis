...
output: 
  flexdashboard::flex_dashboard:
    theme : cosmo
    navbar:
      - { icon: fa-question fa-lg , href: "About.html" ,align: left}
...
```{r}
valueBox(value = "Results 11",href="AnalysisOfResults1.html", color= "#FA8072")
```
...
```{r}
valueBox(value = "Results 15",href="AnalysisOfResults1.html", color= "#CD5C5C")
```
