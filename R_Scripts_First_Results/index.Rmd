...
```{r}
valueBox(value = 3,caption = "ssGSEA on KEGG pathways for feature engineering",href="GSVA-KEGG.html",color= "#85C1E9")
```
...
```{r}
valueBox(value = 4,caption = "ssGSEA Oncogenic gene sets for feature engineering",href="GSVA-Oncogenic_Signature.html",color= "#85C1E9")
```
...
```{r}
valueBox(value = 5,caption = "ssGSEA on the Canonical Pathways for feature engineering",href="GSVA.html",color= "#85C1E9")
```
...
```{r}
valueBox(value = 6,caption = "Penalised Cox model on the Oncogenic gene sets for feature engineering",href="OncogenicGeneSets+Pcox.html", color= "#85C1E9")
```
...
```{r}
valueBox(value = 7,caption = "PAFT the Oncogenic gene sets for feature engineering ",href="OncogenicGeneSets+PAFT.html", color= "#85C1E9")
```

### Chart 8

```{r}
valueBox(value = 7.1, caption="Analysis of results 11",href="AnalysisOfResults.html", color= "#FFDAB9")
```
...
```{r}
valueBox(value = 8,caption = "Block HSIC-Lasso for feature selection",href="HSIC-Lasso-Regression.html", color= "#85C1E9")
```

### Chart 9

```{r}
valueBox(value = 8.1, caption= "Analysis of results 11",href="AnalysisOfResults1.html", color= "#FFDAB9")
```
