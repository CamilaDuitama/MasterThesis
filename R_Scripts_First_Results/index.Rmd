...
valueBox(value = 1,caption = "Original SBC implementation in the Verhaak samples present in the TCGA-GBM data set",href="Preliminary_Results.html", color="#85C1E9")
```
...
```{r}
valueBox(value = 2,caption = "Original SBC implementation",href="Results.html",color = "#85C1E9")
``` 
...
```{r}
valueBox(value = 3,caption = "ssGSEA on KEGG pathways for feature engineering",href="GSVA-KEGG.html",color= "#2E86C1")
```
...
```{r}
valueBox(value = 4,caption = "ssGSEA Oncogenic gene sets for feature engineering",href="GSVA-Oncogenic_Signature.html",color= "#2E86C1")
```
...
```{r}
valueBox(value = 5,caption = "ssGSEA on the Canonical Pathways for feature engineering",href="GSVA.html",color= "#2E86C1")
```
...
```{r}
valueBox(value = 6,caption = "Penalised Cox model on the Oncogenic gene sets for feature engineering",href="OncogenicGeneSets+Pcox.html", color= "#21618C")
```
...
```{r}
valueBox(value = 7,caption = "PAFT the Oncogenic gene sets for feature engineering ",href="OncogenicGeneSets+PAFT.html", color= "#21618C")
```
...
```{r}
valueBox(value = 8,caption = "Block HSIC-Lasso for feature selection",href="HSIC-Lasso-Regression.html", color= "#1B4F72")
```
