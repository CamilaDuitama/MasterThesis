...
=====================================     
# Master Thesis :External Validation and characterization of Cancer subtypes using SBC

This is the website were I present the results of my master thesis.

The background of this projet is the SBC, a model that infers clinically relevant cancer subtypes, by jointly clustering molecular data along with survival datain a semi-supervised manner.The original paper and the supplementary material are [here](https://github.com/CamilaDuitama/MasterThesis/tree/master/papers). A graphical representation of the model is this:

(../images/Graphical_model_SBC.png)
