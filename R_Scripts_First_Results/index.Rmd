...
```{r}
valueBox(value = 7.1, caption="Analysis of results 11",href="AnalysisOfResults.html", color= "#5DADE2")
```
...
```{r}
valueBox(value = 8.1, caption= "Analysis of results 11",href="AnalysisOfResults1.html", color= "#5DADE2")
```
