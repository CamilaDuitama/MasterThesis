...
legend("topright", legend = c("Good moderate","Bad moderate","Best","Worst"),fill =c("#b16ed3","#d37f6e","#90d36e","#6ec2d3"), cex = 0.4)
dev.off()
```
...
fit.2 <- eBayes(fit.2, trend= TRUE)
###### Look for DE table
topmiRNA.train<-rownames(topTable(fit.2,number=50))
...
```{r PCA of differentially expressed miRNA for the training}
...
SM_pval <- names(tableSM.adj[order(tableSM.adj)[1:19]]) 
