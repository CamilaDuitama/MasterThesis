...
for (i in colnames(Clinical_TrainingSet)){
  if (i=="X1"|i=="sbc.labels"){
    ...
    if (is.nan(dummie$p.value)==FALSE && p.adjust(dummie$p.value,method="fdr")<0.05){
      print(i)
      print(dummie)
      print("FDR")
      print(p.adjust(unlist(dummie$p.value), method = "fdr"))
    }
  }
}
