...
knitr::opts_chunk$set(cache=TRUE,eval=FALSE,echo=TRUE,warning=FALSE)
```
...
```{r Number of samples, eval=FALSE, include=FALSE, cache=TRUE}
...
```{r Table for censoring information of the training set, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE,cache=TRUE}
...
```{r Table for censoring information of the testing set, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, paged.print=FALSE}
table(censoring.new) %>%
...
```{r Header of mRNA matrix of the training set, echo=FALSE, message=TRUE, warning=TRUE, paged.print=TRUE, cache=TRUE, cache=TRUE}
  Y.pre.train[1:5,1:5] %>%
  kable(caption = "mRNA MicroArray data for the Training set " ) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed","responsive"),full_width = T, position = "center")
```

```{r Header of mRNA matrix of the testing set, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, cache=TRUE}
  Y.pre.test[1:5,1:5] %>%
  kable(caption = "mRNA MicroArray data for the Testing set " ) %>%
  kable_styling(bootstrap_options = c("striped", "hover", "condensed","responsive"),full_width = F, position = "center")
```

```{r PCA of the whole mRNA dataset, echo=FALSE, message=FALSE, warning=FALSE, cache=TRUE, paged.print=FALSE}
...
```{r Table for the SBC signature, echo=FALSE, message=TRUE, warning=TRUE, cache=TRUE}
...
```{r PCA of the signature, echo=FALSE, cache=TRUE}
...
```{r Survival curves for both training and testing set, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, cache=TRUE}
...
```{r Survival curves from training, echo=FALSE, cache=TRUE}
...
```{r PCA from training, echo=FALSE, cache=TRUE}
...
```{r Plot likelihood of burning, echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE, cache=TRUE}
...
```{r Survival curves from testing, echo=FALSE, cache=TRUE}
...
```{r PCA from testing, echo=FALSE, cache=TRUE, cache=TRUE}
...
```{r Consolidated clustering results, echo=FALSE, cache=TRUE}
table(c.sbc) %>%
...
```{r Final table of SBC vs others, echo=FALSE, cache=TRUE}
